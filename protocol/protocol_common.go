...
const (
	...
	PROTOCOL_NSQ_SETTING uint16 = 0x8010

	PROTOCOL_REQ_PRICE uint16 = 0x0004
	PROTOCOL_REP_PRICE uint16 = 0x8004

	PROTOCOL_REQ_TIME uint16 = 0x0005
	PROTOCOL_REP_TIME uint16 = 0x8005

	PROTOCOL_REQ_MODE uint16 = 0x0003
	PROTOCOL_REP_MODE uint16 = 0x8003

	PROTOCOL_REQ_MAX_CURRENT uint16 = 0x0007
	PROTOCOL_REP_MAX_CURRENT uint16 = 0x8007

	PROTOCOL_NSQ_LOGIN uint16 = 0x8001
	PROTOCOL_REP_HEART uint16 = 0x8006

	PROTOCOL_REQ_CHARGING_PREPARE uint16 = 0x8009
	PROTOCOL_REP_CHARGING_PREPARE uint16 = 0x0009
	...
	PROTOCOL_REP_CHARGING_STARTED = 0x000b

	PROTOCOL_REP_CHARGING_UPLOAD = 0x000c
)
